...
public class CreatorRail : Creator
{
    /// <summary>
    /// 초기값 두께
    /// </summary>
    ...
    {
        MPXRail obj = base.Create() as MPXRail;
        obj.DrawDone(null);
    ...
    public override MPXUnityObject CreatePreview()
    {
        if (StartPosition != EndPosition)
        {
            ...
            if (CurrentObject == null)
            {
                ...
                CurrentRail = CurrentObject.GetComponent<MPXRail>();
            }
            ...
            CurrentRail.StartPos = StartPosition;
            CurrentRail.EndPos = EndPosition;
            CurrentRail.Width = Thickness;
            CurrentRail.Height = Height;
            CurrentRail.Draw();
        }
