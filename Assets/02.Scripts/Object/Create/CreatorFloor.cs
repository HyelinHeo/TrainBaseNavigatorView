...
public class CreatorFloor : Creator
{/// <summary>
 /// 초기값 두께
 /// </summary>
    ...
    private void Update()
    {
        ...
        if (UseCreator)
        {
            ...
            if (isStart)
            {
                ...
                //if (Mathf.Abs(StartPosition.x - EndPosition.x) > 3.0f && Mathf.Abs(StartPosition.z - EndPosition.z) > 3.0f)
                {
                    CreatePreview();
                }
            }
    ...
    {
        MPXFloor obj = base.Create() as MPXFloor;
        obj.DrawDone(null);
    ...
    public override MPXUnityObject CreatePreview()
    {
        if (StartPosition != EndPosition)
        {
            ...
            if (CurrentObject == null)
            {
                ...
                CurrentFloor = CurrentObject.GetComponent<MPXFloor>();
            }
            ...
            CurrentFloor.StartPos = StartPosition;
            CurrentFloor.EndPos = EndPosition;
            CurrentFloor.Height = Thickness;
            CurrentFloor.Draw();
        }
